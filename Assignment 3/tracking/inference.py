...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        """
        "*** YOUR CODE HERE ************************************************************************"
        allPossible = util.Counter() # YOU GAVE IT
        for p in self.legalPositions:
            newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, p)) # YOU GAVE IT
            for newPosition, probability in newPosDist.items():
                allPossible[newPosition] = allPossible[newPosition] + probability *self.beliefs[p] # YOU GAVE IT
        self.beliefs = allPossible
